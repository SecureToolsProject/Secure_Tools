...
assert.match(category, /href="\.\/compress\/"/); assert.equal((category.match(/class="category-tool surface"/g) || []).length, 3);
assert.doesNotMatch(category, /metadataInspector|metadataCleaner|categories\.plannedNote/);
